...
title: "Why Did Deleting Copy and Move Constructors Break Default Construction?"
description: "Understand why deleted constructors break default construction, how a destructor affects move generation, and what the Rule of Five means."
...
In [the previous article](../virtual-destructors/), we made a base-class destructor virtual so a derived object could be destroyed safely through a base pointer.
